...
<ul>
  ...
  <li><a href="#about">About</a></li>
	...
	<body>
		...
		<a href="admin_ipnone_search.php"> 
		...
		<div class="col-lg-12">
			<table class="table table-bordered">
				...
				<tbody>
					<?php
						$res=mysqli_query($link, "select * from iphone");
						while ($row=mysqli_fetch_array($res))
						{
							...
							echo "<td>"; echo $row["display"]; echo "</td>";
							echo "<td>"; echo $row["camera"]; echo "</td>";




							echo "<td>"; ?> <a href="iphone_edit.php?id=<?php echo $row["id"];?>"><buttion type="buttion" class="btn btn-success">Edit</buttion></a> <?php echo"</td>";
							
							echo "<td>"; ?> <a href="iphone_delete.php?id=<?php echo $row["id"];?>"><buttion type="buttion" class="btn btn-danger">Delete</buttion></a> <?php echo"</td>";
					...
					?>
								...
								<a href="iphone.php" class btn btn-primary">Back</a>
		</div>
