  ...
  <li><a href="#about">About</a></li>
	...
	<body>
		<div class="container">
			...
			<div class="col-md-5">
				<h2>Insert Your iPad Details...</h2>
				<form action="" name="form1" method="post">
					...
					<div class="form-group">
						<label for="storage">Storage:<span style="color:red; font-weight:bold">*</span></label>
					...
					<a href="ipad_view.php" class="btn btn-primary">View Data List</a>
