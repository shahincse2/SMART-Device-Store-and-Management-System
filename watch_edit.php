<?php
	...
	$res = mysqli_query($link, "select * from watch where id=$id");
...
<ul>
  ...
  <li><a href="#about">About</a></li>
	...
	<body>
		<div class="container">
			...
			<div class="col-md-5">
				...
				<h2>Update Your watch Details...</h2>
				<form action="" name="form1" method="post">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="resolution" placeholder="Enter resolution" name="resolution" value= "<?php echo $resolution; ?>">
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="os" placeholder="Enter os" name="os" value= "<?php echo $os; ?>">
					</div>
					
					<div class="form-group">
						<label for="sensor">Sensor:</label>
						<input type="text" class="form-control" id="sensor" placeholder="Enter sensor" name="sensor" value= "<?php echo $sensor; ?>">
					</div>
	...
	<?php
		...
		{
			mysqli_query($link, "update watch set model='$_POST[model]', company='$_POST[company]', price='$_POST[price]', connection_type='$_POST[connection_type]', resolution='$_POST[resolution]', weight='$_POST[weight]', battery='$_POST[battery]', os='$_POST[os]', sensor='$_POST[sensor]' where id=$id");
			?>
