...
<ul>
  ...
  <li><a href="watch.php">iwatch</a></li>
  ...
  <li><a href="#about">About</a></li>
	...
	<body>
		<div class="container">
			...
			<div class="col-md-5">
				<h2>Insert Your watch Details...</h2>
				<form action="" name="form1" method="post">
					...
					<div class="form-group">
						<label for="connection_type">Connection_type:<span style="color:red; font-weight:bold">*</span></label>
						<input type="text" required=" " class="form-control" id="connection_type" placeholder="Enter connection_type" name="connection_type">
					</div>
					
					<div class="form-group">
						<label for="resolution">Resolution:<span style="color:red; font-weight:bold">*</span></label>
						<input type="text" required=" " class="form-control" id="resolution" placeholder="Enter resolution" name="resolution">
					</div>
					...
					<div class="form-group">
						<label for="os">Operating System:<span style="color:red; font-weight:bold">*</span></label>
						<input type="text" required=" " class="form-control" id="os" placeholder="Enter os" name="os">
					</div>
					
					<div class="form-group">
						<label for="sensor">Sensor:<span style="color:red; font-weight:bold">*</span></label>
						<input type="text" required=" " class="form-control" id="sensor" placeholder="Enter sensor" name="sensor">
					</div>
					...
					<a href="watch_view.php" class="btn btn-primary">View Data List</a>
	...
	<?php
		...
		{
			mysqli_query($link, "insert into watch values (NULL, '$_POST[model]', '$_POST[company]', '$_POST[price]','$_POST[connection_type]','$_POST[resolution]','$_POST[weight]','$_POST[battery]','$_POST[os]','$_POST[sensor]')");
			?>
		...
		{
			mysqli_query($link, "delete from watch where model='$_POST[model]'") or die (mysqli_error($link));
			?>
			<script type= "text/javascript">
		...
		{
			mysqli_query($link, "update watch set model='$_POST[company]' where model='$_POST[model]'") or die (mysqli_error($link));
			?>
			<script type= "text/javascript">
