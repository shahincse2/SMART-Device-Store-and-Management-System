			...
			<div class="col-md-5">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['stud_id']))
                                    {
                                        ...
                                        $query = "SELECT * FROM mac WHERE model='$stud_id' ";
				...
				<tbody><?php
                                            foreach($query_run as $row)
                                            {
												...
												echo "<tr><td style='width:30%'>Model</td>";
												...
												echo "<tr><td>Generation</td>";
												echo "<td>"; echo $row["gen"]; echo "</td>";
												echo "</tr>";
												
												echo "<tr><td>Core</td>";
												echo "<td>"; echo $row["core"]; echo "</td>";
												echo "</tr>";
												...
												echo "<tr>";
												echo "<td>"; ?> <a href="mac_edit.php?id=<?php echo $row["id"];?>"><buttion type="buttion" class="btn btn-success">Edit</buttion></a> <?php echo"</td>";
												
												echo "<td>"; ?> <a href="mac_delete.php?id=<?php echo $row["id"];?>"><buttion type="buttion" class="btn btn-danger">Delete</buttion></a> <?php echo"</td>";
                                ...
                                ?>
								<a href="mac_view.php" class btn btn-primary">Back</a>
